  ...
  const columns = [
    {
      title: "技术方向",
      links: [
        { label: "STM32 / GD32", href: "#/articles" },
        { label: "FreeRTOS / RT-Thread", href: "#/articles" },
        { label: "Linux 设备驱动", href: "#/articles" },
        { label: "RISC-V 架构", href: "#/articles" },
        { label: "CAN / SPI / I2C", href: "#/articles" },
      ],
    },
    {
      title: "资源",
      links: [
        { label: "文章归档", href: "#/articles" },
        { label: "标签索引", href: "#/tags" },
        { label: "开源项目", href: "https://github.com/huaining1/BadLemonWeb", external: true },
        { label: "推荐书单", href: "#/about" },
      ],
    },
    {
      title: "关于",
      links: [
        ...
        { label: "联系方式", href: "mailto:bad.lemon@example.com", external: true },
        { label: "友情链接", href: "https://github.com/huaining1", external: true },
        { label: "RSS 订阅", href: "https://huaining1.github.io/BadLemonWeb/rss.xml", external: true },
      ],
    },
  ];
          ...
          <div>
            ...
            <div className="flex gap-3">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex h-8 w-8 items-center justify-center rounded-lg bg-surface-800 text-surface-400 transition-colors hover:bg-surface-700 hover:text-surface-200"
              >
              ...
              <a
                href="mailto:bad.lemon@example.com"
                className="flex h-8 w-8 items-center justify-center rounded-lg bg-surface-800 text-surface-400 transition-colors hover:bg-surface-700 hover:text-surface-200"
              >
              ...
              <a
                href="https://huaining1.github.io/BadLemonWeb/rss.xml"
                target="_blank"
                rel="noreferrer"
                className="flex h-8 w-8 items-center justify-center rounded-lg bg-surface-800 text-surface-400 transition-colors hover:bg-surface-700 hover:text-surface-200"
              >
